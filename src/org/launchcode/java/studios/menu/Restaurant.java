...
public class Restaurant {
    public static void main(String[] args) {
        //Create menu 5 menu items, using the menuItem class to create new instnace of the class aka An Object.
        MenuItem item1 = new MenuItem("Sudado de Polo", "Stewed Chicken and Potatoes", 15.99, "Colombian");
        MenuItem item2 = new MenuItem("Cake", "The Chocolate Cake (Its Real)", 4.59, "Dessert");
